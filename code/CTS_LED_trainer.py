...
if __name__ == "__main__":
    ...
    argparser.add_argument('--train_retrieved_ids', type=str, default="sorted_ROUGE_train.jsonl")
    argparser.add_argument('--distant_retrieved_ids', type=str, default="sorted_ROUGE_distant.jsonl")
    argparser.add_argument('--dev_retrieved_ids', type=str, default="sorted_ROUGE_test.jsonl")
...
default="cited_text_embeddings_citation_mark/cited_papers")         
    ...
    argparser.add_argument('--checkpoint', type=str, default="oracle_CTS_citation_span_generator/")
    ...
    argparser.add_argument('--add_keywords', action='store_true')
    ...
    trainer.train(model_path=args.checkpoint)