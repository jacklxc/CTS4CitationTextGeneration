...
if __name__ == "__main__":
    ...
    argparser.add_argument('--exclude_intro', action='store_true')
    argparser.add_argument('--skip_no_citations', action='store_true')
    argparser.add_argument('--best_CTS_rouge', action='store_true')
    ...
    training_set = CitationTextGenerationDataset(
         ...
         best_CTS_rouge = args.best_CTS_rouge,
    )
